<?php 
  ...
  require_once('connect_azure_db.php');
    ...
    try{
        ...
        $stmnt = $pdo->prepare('SELECT v.auctionID, COUNT(v.userID), i.itemID, i.name, i.photo, i.description, i.`condition`, i.quantity, i.categoryName, i.sellerID, a.startPrice, a.reservePrice, a.buyNowPrice, a.endTime, b.highestBid
                    FROM viewing AS v
